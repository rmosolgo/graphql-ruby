...
You can generate an Input Object from an Object using `generate_from_object_type` method, please note that this checks `as_input` flag in the fields and automatically omits fields which return unssuported types, like Union, Object or Interface.
Manual arguments definitions will override those generated by this method.

```ruby
class ExampleObjectType < GraphQL::Schema::Object
  field :id, ID, null: false
end

class ExampleInput < GraphQL::Schema::InputObject
  generate_from_object_type ExampleObjectType
end
```
