...
`GraphQL::Relay` is provided with the `graphql` gem. To use it, install `graphql` and require `"graphql/relay"` in your app.
...
```ruby
# config/intializers/graphql.rb
# Load GraphQL::Relay helpers:
