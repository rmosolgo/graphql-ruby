...
module GraphQL
  module Pagination
    ...
    class Connection
      ...
      # - `parent` (`Object`) — The object this collection belongs to
      ...
      # **Parameters**
      #
      # - `item` (`Object`) — An item newly added to `items`
      #
      # **Returns**
      #
      # - `Edge`
      ...
      # **Parameters**
      #
      # - `item` (`Object`) — one of the passed in [items](rdoc-ref:items), taken from [nodes](rdoc-ref:nodes)
      #
      # **Returns**
      #
      # - `String`
