...
module GraphQL
  class Schema
    class Field
      ...
      # @param dataload_association [true, Symbol] true if `dataload_assocation(...)` should be used for this field. {name} is used by default, pass another symbol to override this.
      def initialize(type: nil, name: nil, owner: nil, null: nil, description: NOT_CONFIGURED, comment: NOT_CONFIGURED, deprecation_reason: nil, method: nil, hash_key: nil, dig: nil, resolver_method: nil, connection: nil, max_page_size: NOT_CONFIGURED, default_page_size: NOT_CONFIGURED, scope: nil, introspection: false, camelize: true, trace: nil, complexity: nil, ast_node: nil, extras: EMPTY_ARRAY, extensions: EMPTY_ARRAY, connection_extension: self.class.connection_extension, resolver_class: nil, subscription_scope: nil, relay_node_field: false, relay_nodes_field: false, method_conflict_warning: true, broadcastable: NOT_CONFIGURED, arguments: EMPTY_HASH, directives: EMPTY_HASH, validates: EMPTY_ARRAY, fallback_value: NOT_CONFIGURED, dynamic_introspection: false, dataload_association: false, &definition_block)
        if name.nil?
        ...
        if dataload_association
          dataload_name = dataload_association == true ? name : dataload_association
          resolver_method = "dataload_#{dataload_name}_association"
          owner.module_eval <<-RUBY, __FILE__, __LINE__
            def #{resolver_method}
              dataload_association(#{dataload_name.inspect})
            end
          RUBY
        end
