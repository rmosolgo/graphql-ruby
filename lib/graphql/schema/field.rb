...
module GraphQL
  class Schema
    class Field
      ...
      def initialize(name, return_type_expr = nil, desc = nil, null: nil, field: nil, function: nil, description: nil, deprecation_reason: nil, method: nil, connection: nil, max_page_size: nil, resolve: nil, extras: [], &args_block)
        if !(field || function)
