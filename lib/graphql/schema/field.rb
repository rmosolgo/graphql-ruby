...
module GraphQL
  class Schema
    class Field
      ...
      # @return [Boolean] Information if this field should be skipped when generating InputType from the parent Object
      attr_reader :as_input
