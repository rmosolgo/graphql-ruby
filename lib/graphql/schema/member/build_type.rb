...
require 'graphql/schema/string_utils'
  ...
  class Schema
    class Member
      ...
      module BuildType
        ...
        def camelize(string)
          GraphQL::Schema::StringUtils.camelize(string)
        end

        # Resolves constant from string (based on Rails `ActiveSupport::Inflector.constantize`)
        def constantize(string)
          GraphQL::Schema::StringUtils.constantize(string)
        end

        def underscore(string)
          GraphQL::Schema::StringUtils.underscore(string)
        end
      end
    end
  end
