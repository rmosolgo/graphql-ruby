  ...
  module Execution
    ...
    class Execute
      ...
      def execute(ast_operation, root_type, query)
        GraphQL::Deprecated.warn "#{self.class} will be removed in GraphQL-Ruby 2.0, please upgrade to the Interpreter: https://graphql-ruby.org/queries/interpreter.html"
