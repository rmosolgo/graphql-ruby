        ...
        class GraphQLResultHash
          ...
          def resolve_abstract_type
            ...
            @resolve_type_result = begin
              ...
              @runtime.continue_value(ex_err, @graphql_field, @graphql_is_non_null_in_parent, @ast_node, @graphql_result_name, @graphql_parent)
            ...
            if reenqueue_if_lazy?(@resolve_type_result)
          ...
          def authorize_application_value
            if @was_scoped
              ...
              return handle_authorized_application_value
            end
            @runtime.current_trace.begin_authorized(@graphql_result_type, @graphql_application_value, @runtime.context)
            begin
              ...
              if reenqueue_if_lazy?(@authorized_check_result)
          ...
          def handle_authorized_application_value
            ...
            @authorized_check_result = nil
            if reenqueue_if_lazy?(@graphql_application_value)
              @step = :handle_wrapped_application_value
            else
              handle_wrapped_application_value
            end
          end

          def handle_wrapped_application_value
