    ...
    class Interpreter
      ...
      def self.use(schema_class)
        if schema_class.interpreter?
          ...
          GraphQL::Deprecated.warn("GraphQL::Execution::Interpreter is now the default; remove `use GraphQL::Execution::Interpreter` from the schema definition (#{definition_line})")
        else
