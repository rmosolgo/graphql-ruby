%%{
  ...
  BLOCK_QUOTE =   '"""';
  SHORT_BLOCK_QUOTES = ('' | '"' | '""');
  BLOCK_STRING_FRAGMENT = SHORT_BLOCK_QUOTES [^\\"]+;
  BLOCK_STRING_ESCAPE_FRAGMENT = SHORT_BLOCK_QUOTES '\\'+;
  BLOCK_STRING_CHAR = (BLOCK_STRING_ESCAPE_FRAGMENT+ '"""' | BLOCK_STRING_ESCAPE_FRAGMENT* BLOCK_STRING_FRAGMENT);
  BACKSLASH_ESCAPED_CHAR = '\\' /./;
  STRING_CHAR =   (BACKSLASH_ESCAPED_CHAR | [^\\"]);
  VAR_SIGN =      '$';
  DIR_SIGN =      '@';
  ELLIPSIS =      '...';
  EQUALS =        '=';
