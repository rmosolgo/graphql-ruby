...
# Primary metric: realistic workloads only (excludes pathological fields_merge)
realistic = (times[:introspection] + times[:abstract_frags] + times[:abstract_frags2] + times[:big_query]).round(1)
