...
A Ruby implementation of [GraphQL](http://graphql.org/).
 ...
 - Guides
     ...
     - [Use with Relay.js](http://www.rubydoc.info/github/rmosolgo/graphql-ruby/file/guides/relay.md)
...
- `require "graphql/relay"`, which loads [complementary Relay helpers, `GraphQL::Relay`]((http://www.rubydoc.info/github/rmosolgo/graphql-ruby/file/guides/relay.md)).
