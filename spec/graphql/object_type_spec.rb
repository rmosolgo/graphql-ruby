...
describe GraphQL::ObjectType do
  ...
  describe "namespaced" do
    ...
    it "has a name" do
      assert_equal("Post", type.name)
    end

    it "has a description" do
      assert_equal("A blog post with a namespaced model", type.description)
    end

    it "has a resolved_class_name" do
      assert_equal("Acme::Post", type.resolved_class_name)
    end
  end
end
