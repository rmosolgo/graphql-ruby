...
REASON
    ...
    comment_type = Class.new(GraphQL::Schema::Object) do
      ...
      field :id, "ID", null: false, definition_directives: {"topSecret" => nil, "authorize" => { "role" => "superuser" }}
    end
    ...
    post_type = GraphQL::ObjectType.define do
      ...
      field :comments, types[comment_type.to_non_null_type]
...
type Comment implements Node {
  id: ID! @topSecret @authorize(role: \"superuser\")
}
