...
describe GraphQL::Schema::Mutation do
  ...
  describe "definition" do
    it "passes along description" do
      assert_equal "Register a new musical instrument in the database", mutation.field_signature[:description]
  ...
  describe "a derived field" do
    it "gets a name from the mutation" do
      field = GraphQL::Schema::Field.from_signature(mutation.field_signature)
      assert_equal "addInstrument", field.name
    end

    it "has a reference to the mutation" do
      f = GraphQL::Schema::Field.from_signature(mutation.field_signature)
  ...
  describe ".null" do
    it "overrides whether or not the field can be null" do
      ...
      assert default_mutation_class.field_signature[:null]
      assert nullable_mutation_class.field_signature[:null]
      refute non_nullable_mutation_class.field_signature[:null]
    end
    ...
    it "should inherit and override in subclasses" do
      ...
      assert_equal false, inheriting_mutation.field_signature[:null]
      assert override_mutation.field_signature[:null]
    end
  end
end
