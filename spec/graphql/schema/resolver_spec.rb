...
describe GraphQL::Schema::Resolver do
  ...
  describe "When the type is forgotten" do
    ...
    it "raises a nice error" do
      ...
      expected_message = "Can't determine the return type for Query.withoutType (it has `resolver: ResolverWithoutTypeSchema::WithoutType`, consider configuration a `type ...` for that class, or perhaps its type causes a cyclical loading issue)"
