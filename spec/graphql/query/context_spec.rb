...
describe GraphQL::Query::Context do
  ...
  describe "read values" do
    ...
    it "allows you to read values of contexts using dig" do
      ...
      Thread.current[:__graphql_runtime] = OpenStruct.new(current_arguments: {c: 1})
  ...
  it "can override values set by runtime" do
    ...
    Thread.current[:__graphql_runtime] = OpenStruct.new({ current_object: :runtime_value })
  ...
  describe "scoped context" do
    ...
    it "always retrieves a scoped context value if set" do
      ...
      Thread.current[:__graphql_runtime] = dummy_runtime
    ...
    it "has a #current_path method" do
      ...
      Thread.current[:__graphql_runtime] = OpenStruct.new(current_result: current_result)
