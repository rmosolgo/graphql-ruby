...
describe GraphQL::Define::AssignArgument do
  it "it accepts default_value" do
    arg = define_argument(:a, GraphQL::DEPRECATED_STRING_TYPE, default_value: 'Default')
  ...
  it "default_value is optional" do
    arg = define_argument(:a, GraphQL::DEPRECATED_STRING_TYPE)
  ...
  it "default_value can be explicitly set to nil" do
    arg = define_argument(:a, GraphQL::DEPRECATED_STRING_TYPE, default_value: nil)
  ...
  it "passing unknown keyword arguments will raise" do
    err = assert_raises GraphQL::Define::NoDefinitionError do
      define_argument(:a, GraphQL::DEPRECATED_STRING_TYPE, blah: nil)
    end

    assert_equal "GraphQL::Argument can't define 'blah'", err.message

    err = assert_raises GraphQL::Define::NoDefinitionError do
      define_argument(:a, GraphQL::DEPRECATED_STRING_TYPE, blah: nil, blah2: nil)
    end
