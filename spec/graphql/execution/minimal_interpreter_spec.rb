...
describe GraphQL::Execution::MinimalInterpreter do
  module MinimalInterpreterTest
    class Box
    ...
    class Expansion < GraphQL::Schema::Object
      ...
      field :cards, ["MinimalInterpreterTest::Card"], null: false
    ...
    class Card < GraphQL::Schema::Object
      field :name, String, null: false
      field :colors, "[MinimalInterpreterTest::Color]", null: false
    ...
    class Schema < GraphQL::Schema
      ...
      use(GraphQL::Execution::MinimalInterpreter)
      ...
      class EnsureArgsAreObject
        def self.trace(event, data)
          ...
          when "execute_field", "execute_field_lazy"
            ...
            if !args.is_a?(GraphQL::Execution::MinimalInterpreter::Arguments)
  ...
  it "runs a query" do
    ...
    result = MinimalInterpreterTest::Schema.execute(query_string, variables: vars)
  ...
  #   result = MinimalInterpreterTest::Schema.execute(query_str, context: { counter: OpenStruct.new(value: 0) })
  #   expected_data = {
  #     "i1" => {
  #       "value" => 1,
  ...
  #   result = MinimalInterpreterTest::Schema.execute(query_str, variables: vars)
  #   expected_data = {
  ...
  describe "temporary interpreter flag" do
    it "is set" do
      ...
      res = MinimalInterpreterTest::Schema.execute("{ __typename }")
  ...
  #   it "is available" do
  #     res = MinimalInterpreterTest::Schema.execute <<-GRAPHQL
  #     {
  #       fieldCounter {
  #         runtimeInfo(a: 1, b: 2)
  #         fieldCounter {
  ...
  describe "null propagation" do
    it "propagates nulls" do
      ...
      res = MinimalInterpreterTest::Schema.execute(query_str)
  ...
  #     res = MinimalInterpreterTest::Schema.execute(query_str, context: { calls: 0 })
  ...
  #     res = MinimalInterpreterTest::Schema.execute('{ node(id: "abc") { id } }')
  #     assert_equal "abc", res["data"]["node"]["id"]

  #     res = MinimalInterpreterTest::Schema.execute('{ nodes(ids: ["abc", "xyz"]) { id } }')
  ...
  #   assert_equal "MinimalInterpreterTest::Query::ExpansionData", res["data"]["expansion"]["cards"].first["parentClassName"]
  # end
end
