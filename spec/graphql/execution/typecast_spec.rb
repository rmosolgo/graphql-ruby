...
describe GraphQL::Execution::Typecast do
  describe ".subtype?" do
    ...
    it "counts member types as subtypes" do
      assert subtype?(Dummy::Types::EdibleInterface, Dummy::CheeseType)
      assert subtype?(Dummy::Types::EdibleInterface, Dummy::MilkType)
    ...
    it "counts lists as subtypes if their inner types are subtypes" do
      assert subtype?(Dummy::Types::EdibleInterface.to_list_type, Dummy::MilkType.to_list_type)
    ...
    it "counts non-null types as subtypes of nullable parent types" do
      ...
      assert subtype?(Dummy::Types::EdibleInterface, Dummy::MilkType.to_non_null_type)
      assert subtype?(Dummy::Types::EdibleInterface.to_non_null_type, Dummy::MilkType.to_non_null_type)
      assert subtype?(
