      ...
      def self.included(child_class)
        child_class.class_eval do
          ...
          it "runs IO in parallel by default" do
            ...
            assert_in_delta 0.3, ended_at - started_at, 0.07, "IO ran in parallel"
          end
          ...
          it "works with sources" do
            ...
            assert_equal 0.3, v2
            assert_equal 0.3, v3
            assert_in_delta 0.0, started_at_2 - ended_at_2, 0.07, "Already-loaded values returned instantly"
          ...
          it "nested fields don't wait for slower higher-level fields" do
            ...
            assert_in_delta 0.3, ended_at - started_at, 0.07, "Fields ran without any waiting"
          end
