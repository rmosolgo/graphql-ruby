...
%%
  ...
  literal_value:
    ...
    | TRUE_LITERAL        { result = true }
    | FALSE_LITERAL       { result = false }
    | null_value
    | enum_value
    | list_value
  ...
  null_value: NULL_LITERAL { result = make_node(:NullValue, name: val[0], position_source: val[0]) }
  ...
  object_type_extension:
      ...
      EXTEND TYPE_LITERAL name implements field_definition_list_opt { result = make_node(:ObjectTypeExtension, name: val[2], interfaces: val[3], directives: [], fields: val[4], position_source: val[0]) }
    | EXTEND TYPE_LITERAL name implements_opt directives_list_opt field_definition_list_opt { result = make_node(:ObjectTypeExtension, name: val[2], interfaces: val[3], directives: val[4], fields: val[5], position_source: val[0]) }
    | EXTEND TYPE_LITERAL name implements_opt directives_list { result = make_node(:ObjectTypeExtension, name: val[2], interfaces: val[3], directives: val[4], fields: [], position_source: val[0]) }
    | EXTEND TYPE_LITERAL name implements { result = make_node(:ObjectTypeExtension, name: val[2], interfaces: val[3], directives: [], fields: [], position_source: val[0]) }
